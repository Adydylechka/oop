...
import main.java.by.bsuir.oop.fourth.decorator.CompressionDecorator;
import main.java.by.bsuir.oop.fourth.decorator.EncryptionDecorator;
import main.java.by.bsuir.oop.fourth.decorator.FileAddressDecorator;
...
import main.java.by.bsuir.oop.fourth.serialization.impl.BinarySerializeStrategy;
import main.java.by.bsuir.oop.fourth.serialization.impl.CustomTablesSerializeStrategy;
import main.java.by.bsuir.oop.fourth.serialization.impl.YAMLSerializeStrategy;
import main.java.by.bsuir.oop.fourth.starter.Main;
import main.java.by.bsuir.oop.fourth.util.api.FileAddress;
import main.java.by.bsuir.oop.fourth.util.impl.Info;
import main.java.by.bsuir.oop.fourth.util.impl.SimpleFileAddress;
...
public final class PrimaryController {
    ...
    void initialize() {
        ...
        deserializeButton.setOnAction(e -> {
            ...
            Container<Flat> oldContainer = info.getTables();
    ...
    private void updateWorker() throws InstantiationException, IllegalAccessException,
        ...
        FileAddress anotherWorker = SimpleFileAddress.getWorker();
        FileAddressDecorator decorator = new FileAddressDecorator(anotherWorker);
